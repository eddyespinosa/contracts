...
contract DocVersionControl { 
  ...
  uint numberOfUploads;
  uint numberOfApprovals; 
  uint numberOfRequestsByDevelopers; 
  uint  numberOfNewRequests;
  ...
  string IPFShashForDocument;
    ...
    mapping (address=>developerState) public developers; 
    mapping(address=>newRegistrationState) public newEntry;
    ...
    developer1= 0xd9145CCE52D386f254917e481eB44e9943F39138;
    numberOfApprovals = 0; 
    numberOfUploads = 0;
    numberOfNewRequests=0; 
    numberOfRequestsByDevelopers=0;
  }
//functions 
